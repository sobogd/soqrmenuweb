// Generate 4 frames for the slideshow video — same text/CTA, different bg.
// Output: ad_v2_bg_f1.jpg .. ad_v2_bg_f4.jpg
...
// Order matches the photo cards in the 4-card variant (TL → TR → BL → BR)
const BGS = [
  { file: "c2_menu.png",     position: "centre", out: "ad_v2_bg_f1.jpg" },
  { file: "c2_reserve.webp", position: "east",   out: "ad_v2_bg_f2.jpg" },
  { file: "c2_phones.webp",  position: "centre", out: "ad_v2_bg_f3.jpg" },
  { file: "c2_kitchen.jpg",  position: "centre", out: "ad_v2_bg_f4.jpg" },
];

async function frame({ file, position, out }) {
  ...
  const REST_W = 122, TILE_W = 80, LOGO_GAP = 16;
...
(async () => {
  for (const b of BGS) await frame(b);
  console.log("done all frames");
