...
export const CRO: CroCopy = {
  hero: {
    ...
    sub: "An t-ardán iomlán chun bialann nua-aimseartha a rith — galánta, gach rud in aon áit amháin, gan scileanna teicniúla.",
  },
  ...
  benefits: [
    { Icon: Languages, tag: "Biachlár digiteach", title: "Biachlár atá cosúil le suíomh, ní PDF.", bullets: ["35 teanga le IS","Dearadh den scoth","Praghsanna láithreach"], image: "/landing/feature-design.webp", imageAlt: "Dhá fhón ar bhord caifé: scáileán fáilte an bhiachláir dhigitigh agus an leathanach teagmhála le léarscáil" },
    { Icon: ChefHat, tag: "Scáileán cistine", title: "An chistin, gan pháipéar faoi dheireadh.", bullets: ["Beo ar an scáileán","Nótaí is ailléirginí","Táibléad nó fón"], image: "/landing/feature-kds-cards.webp", imageAlt: "Táibléad ag an mbeár ag taispeáint scáileán na cistine le horduithe de réir boird" },
    { Icon: CalendarCheck, tag: "Áirithintí", title: "Boird a chuireann iad féin in áirithe, 24/7.", bullets: ["Áirithint féinseirbhíse","Deimhniú uathoibríoch","Féilire de réir boird"], image: "/landing/feature-booking-calendar.webp", imageAlt: "Dhá tháibléad ag taispeáint an fhéilire áirithintí: amharc laethúil de réir boird agus amharc míosúil" },
    { Icon: Receipt, tag: "Orduithe ag an mbord", title: "Glac orduithe gan leabhar nótaí — roghnach.", bullets: ["Aoi nó freastalaí","Díreach go dtí an chistin","Cas air am ar bith"], image: "/landing/feature-orders.webp", imageAlt: "Freastalaí ag glacadh ordú ag an mbord ar an bhfón, sroicheann sé scáileán na cistine" },
  ],
