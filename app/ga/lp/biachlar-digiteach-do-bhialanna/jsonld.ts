...
const URL_SELF = "https://iq-rest.com/ga/lp/biachlar-digiteach-do-bhialanna";
const URL_HOME = "https://iq-rest.com/ga";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Biachlár digiteach do bhialanna",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Biachlár digiteach do bhialanna", item: URL_SELF },
    ],
  };
