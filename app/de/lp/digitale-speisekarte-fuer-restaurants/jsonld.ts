...
const URL_SELF = "https://iq-rest.com/de/lp/digitale-speisekarte-fuer-restaurants";
const URL_HOME = "https://iq-rest.com/de";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digitale Speisekarte für Restaurants",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digitale Speisekarte für Restaurants", item: URL_SELF },
    ],
  };
