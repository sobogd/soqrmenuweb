...
export const TEXTS: FeatureTexts = {
  meta: {
    title: "KI-Übersetzung der Speisekarte — 35 Sprachen, ein Tipp",
    description:
      "Übersetze deine ganze Speisekarte in 35 Sprachen mit einer KI, die kulinarischen Kontext versteht. Ein Tipp, sofortige Ergebnisse. 14 Tage gratis, ohne Karte.",
    canonical: "https://iq-rest.com/de/ai-translation",
    ogLocale: "de_DE",
    ogTitle: "KI-Übersetzung der Speisekarte — Übersetze deine Restaurantkarte in 35 Sprachen",
    ogDescription:
      "Touristen bestellen mehr, wenn sie die Karte verstehen. KI-Übersetzung speziell für Gastronomie — bewahrt Gerichtsnamen, trifft Beschreibungen, sofort fertig.",
  },
  ...
  pricing: {
    heading: "Ein Tarif.",
    headingAccent: "35 Sprachen inklusive.",
    sub: "KI-Übersetzung, QR-Karte, Online-Bestellung und Reservierungen — alles im Festpreis. Keine Gebühren pro Sprache, keine pro Übersetzung, niemals.",
  },

  faq: {
    sub: "Alles, was Gastronomen zur Karten­übersetzung fragen. Deine Frage nicht dabei? Schreib uns auf WhatsApp — echte Menschen antworten.",
    items: [
      {
        q: "Wie genau ist die KI im Vergleich zu Google Translate?",
        a: "Deutlich besser für Gastronomie. Google Translate weiß nicht, dass 'Pulpo a la gallega' nicht Wort für Wort übersetzt wird oder dass 'Amuse-Bouche' auf einer Fine-Dining-Karte französisch bleibt. Unsere KI wurde auf echten Restaurantkarten trainiert und weiß, wann zu übersetzen, wann zu transliterieren und wann das Original zu lassen ist. Du kannst auch jede Übersetzung manuell bearbeiten — nützlich für regionale Schreibweisen.",
      },
      {
        q: "Wie viele Sprachen unterstützt ihr?",
        a: "35 Sprachen out of the box: Englisch, Spanisch, Deutsch, Französisch, Italienisch, Portugiesisch, Niederländisch, Polnisch, Tschechisch, Slowakisch, Ungarisch, Rumänisch, Bulgarisch, Kroatisch, Serbisch, Slowenisch, Griechisch, Türkisch, Russisch, Ukrainisch, Litauisch, Lettisch, Estnisch, Finnisch, Schwedisch, Norwegisch, Dänisch, Isländisch, Katalanisch, Irisch-Gälisch, Arabisch, Persisch, Japanisch, Koreanisch und Chinesisch. RTL-Schriften wie Arabisch und Persisch werden out of the box korrekt gerendert.",
      },
      {
        q: "Muss ich erst alles manuell übersetzen?",
        a: "Nein. Schreibe deine Karte in deiner Muttersprache, klicke 'übersetzen', wähle die gewünschten Sprachen — die KI macht den Rest. Du kannst jede Übersetzung prüfen und bearbeiten, musst aber nicht. Die meisten Restaurants richten es einmal ein und vergessen es.",
      },
      {
        q: "Was passiert, wenn ich ein neues Gericht hinzufüge?",
        a: "Es wird automatisch in jede aktive Sprache übersetzt. Du fügst 'Trüffelrisotto' auf Deutsch mit Beschreibung hinzu, drückst speichern, und innerhalb von Sekunden erscheint das Gericht übersetzt in allen aktiven Sprachen. Nichts neu starten, keine Batch-Jobs.",
      },
      {
        q: "Können Gäste die Sprache auf der Karte wechseln?",
        a: "Ja. Die QR-Karte hat oben einen Sprachwähler — Gäste tippen eine Flagge an, die ganze Karte wird in ihrer Sprache neu gerendert. Oder du lässt sie automatisch aus den Spracheinstellungen des Handys erkennen, sodass ein französischer Tourist beim Scannen sofort Französisch sieht. Keine Buttons zu suchen, keine Reibung.",
      },
    ],
  },

  finalCta: {
    heading: "Touristen können sie lesen.",
    headingAccent: "Touristen bestellen mehr.",
    sub: "Übersetze deine Karte mit einem Klick in 35 Sprachen. 14 Tage gratis. Keine Karte. Keine Gebühren pro Sprache, niemals.",
  },
};
