...
const URL_SELF = "https://iq-rest.com/et/lp/digitaalne-menuu-restoranidele";
const URL_HOME = "https://iq-rest.com/et";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digitaalne menüü restoranidele",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digitaalne menüü restoranidele", item: URL_SELF },
    ],
  };
