...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "QR-menüü 5 minutiga.", sub: "Valmis veebisait teie restoranile — ilma arendajate ja alltöövõtjateta. Otsetellimused, broneeringud ja külaliste analüütika ühes tellimuses." },
    web: { headline: "Restorani veebileht 5 min.", sub: "Valmis veebisait teie restoranile — ilma arendajate ja alltöövõtjateta. Otsetellimused, broneeringud ja külaliste analüütika ühes tellimuses." },
