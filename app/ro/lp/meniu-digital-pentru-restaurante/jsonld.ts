...
const URL_SELF = "https://iq-rest.com/ro/lp/meniu-digital-pentru-restaurante";
const URL_HOME = "https://iq-rest.com/ro";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Meniu digital pentru restaurante",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Meniu digital pentru restaurante", item: URL_SELF },
    ],
  };
