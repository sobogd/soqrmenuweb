...
export const TEXTS: FeatureTexts = {
  meta: {
    title: "AI-restaurangmenyöversättning — 35 språk, en knapptryckning",
    description:
      "Översätt hela din restaurangmeny till 35 språk med AI som förstår kulinarisk kontext. En knapptryckning, omedelbara resultat. 14 dagars gratis provperiod, inget kreditkort.",
    canonical: "https://iq-rest.com/sv/ai-translation",
    ogLocale: "sv_SE",
    ogTitle: "AI-menyöversättning — översätt din restaurangmeny till 35 språk",
    ogDescription:
      "Turister beställer mer när de förstår menyn. AI-översättning byggd för mat — bevarar rättnamn, får beskrivningar rätt, klar direkt.",
  },

  hero: {
    title: "Kan turister inte läsa din meny? Fixa det med en knapptryckning.",
    subtitle:
  ...
  pricing: {
    heading: "En plan.",
    headingAccent: "35 språk ingår.",
    sub: "AI-översättning, QR-meny, onlinebeställning och bordsbokningar — allt ingår i ett fast pris. Inga avgifter per språk, inga avgifter per översättning, någonsin.",
  },

  faq: {
    sub: "Allt restaurangägare frågar om menyöversättning. Ser du inte din? Skicka oss ett meddelande på WhatsApp — riktiga människor svarar.",
    items: [
      {
        q: "Hur exakt är AI:n jämfört med Google Translate?",
      ...
      {
        q: "Hur många språk stöder ni?",
        a: "35 språk direkt: engelska, spanska, tyska, franska, italienska, portugisiska, nederländska, polska, tjeckiska, slovakiska, ungerska, rumänska, bulgariska, kroatiska, serbiska, slovenska, grekiska, turkiska, ryska, ukrainska, litauiska, lettiska, estniska, finska, svenska, norska, danska, isländska, katalanska, irisk-gaeliska, arabiska, persiska, japanska, koreanska och kinesiska. RTL-skript som arabiska och persiska renderas korrekt direkt.",
      },
      {
        q: "Måste jag översätta allt manuellt först?",
        a: "Nej. Skriv din meny på ditt modersmål, klicka 'översätt', välj språken du vill ha — AI:n gör resten. Du kan granska och redigera vilken översättning som helst, men du måste inte. De flesta restauranger ställer in det en gång och glömmer det.",
      },
      {
        q: "Vad händer när jag lägger till en ny rätt?",
        a: "Den auto-översätts till varje språk du har aktiverat. Du lägger till 'Tryffelrisotto' på svenska med en beskrivning, trycker spara, och inom sekunder visas rätten översatt på alla aktiva språk. Inga omkörningar, inga batchjobb.",
      },
      {
        q: "Kan gäster byta språk på menyn?",
        a: "Ja. QR-menyn har en språkväljare högst upp — gäster trycker på en flagga, hela menyn renderas om på deras språk. Eller så kan du låta den auto-detektera från telefonens språkinställningar, så att en fransk turist som skannar din QR ser franska direkt. Inga knappar att hitta, ingen friktion.",
      },
    ],
  },

  finalCta: {
    heading: "Turister kan läsa det.",
    headingAccent: "Turister beställer mer.",
    sub: "Översätt din meny till 35 språk med ett klick. 14 dagars gratis provperiod. Inget kreditkort. Inga avgifter per språk, någonsin.",
  },
};
