...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    variants: [
      { headline: "Sluta trycka menyer.", headlineAccent: "Sluta betala 30% till leveransappar.", sub: "QR-meny, direkta beställningar, bokningar och flerspråkig webbplats. Klar på 2 minuter — utan kort." },
      { headline: "Din restaurang förtjänar mer än", headlineAccent: "pappersmenyer och missade samtal.", sub: "Direkta beställningar, omedelbara meny-uppdateringar och bokningar 24/7. Igång på 2 minuter." },
      { headline: "En QR-kod.", headlineAccent: "Noll provision. Adjö papper.", sub: "QR-meny, onlinebeställningar och bokningar — allt på ett ställe. 14 dagar gratis, utan kort." },
      { headline: "Få direkta beställningar.", headlineAccent: "Hoppa över provisionen.", sub: "Gäster skannar, beställer och betalar — direkt till dig, utan Foodora-snitt. Klar på 2 minuter." },
      { headline: "Fler beställningar. Fler bokningar.", headlineAccent: "Inget papper, inga appar.", sub: "QR-meny + bokningar + flerspråkig sajt på autopilot. 14 dagar gratis." },
      { headline: "Turister förstår inte menyn?", headlineAccent: "Löst på 2 minuter.", sub: "AI översätter hela menyn till 35 språk. Plus QR-beställningar och bokningar inkluderade." },
      { headline: "Från pappersmeny till QR-kod,", headlineAccent: "innan espresson kallnar.", sub: "QR-meny, direkta beställningar och bokningar 24/7. Klar på 2 minuter — utan kort." },
      { headline: "Befriande enkel QR-meny.", headlineAccent: "Tyst kraftfull under ytan.", sub: "Direkta beställningar, AI-översättning, bokningar och webbplats — allt med ett klick på telefonen." },
    ],
    painBullets: ["Inga utskrifter — ändra priser direkt", "Noll provision — beställningar rakt till dig", "Inga missade samtal — bokningar 24/7", "35 språk — tappa aldrig en turist"],
