...
const HOME_HERO = {
  title: "Sve što vašem restoranu treba. Na jednoj platformi.",
  ...
  exploreCta: "Sve mogućnosti",
};

const FEATURE_IMAGES: Record<string, string> = {
  "Digitalni jelovnik": "/landing/hero-cafe.webp",
  "Narudžbe": "/landing/feature-orders.webp",
  "Rezervacije": "/landing/feature-reservation.webp",
