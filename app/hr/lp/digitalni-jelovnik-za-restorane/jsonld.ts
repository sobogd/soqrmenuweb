...
const URL_SELF = "https://iq-rest.com/hr/lp/digitalni-jelovnik-za-restorane";
const URL_HOME = "https://iq-rest.com/hr";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digitalni jelovnik za restorane",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digitalni jelovnik za restorane", item: URL_SELF },
    ],
  };
