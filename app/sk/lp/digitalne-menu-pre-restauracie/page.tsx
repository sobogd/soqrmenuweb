...
export const metadata: Metadata = {
  ...
  // Noindex: /sk carries the organic SEO; this URL is a PPC LP only.
  robots: {
    index: false,
    follow: true,
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/og/menu-digitale.png", width: 1200, height: 630, alt: "Digitálne menu pre reštaurácie — IQ Rest" }],
  },
  twitter: {
