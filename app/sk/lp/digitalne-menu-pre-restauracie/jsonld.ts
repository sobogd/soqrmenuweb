...
const URL_SELF = "https://iq-rest.com/sk/lp/digitalne-menu-pre-restauracie";
const URL_HOME = "https://iq-rest.com/sk";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digitálne menu pre reštaurácie",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digitálne menu pre reštaurácie", item: URL_SELF },
    ],
  };
