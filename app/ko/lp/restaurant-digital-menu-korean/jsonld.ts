...
const URL_SELF = "https://iq-rest.com/ko/lp/restaurant-digital-menu-korean";
const URL_HOME = "https://iq-rest.com/ko";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "레스토랑용 디지털 메뉴", item: URL_SELF },
    ],
  };
