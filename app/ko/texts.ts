...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "5분 만에 QR 메뉴 완성.", sub: "직접 주문, 예약, 35개국어 지원. 수수료 및 개발자 필요 없음." },
    web: { headline: "5분 만에 레스토랑 웹 제작.", sub: "직접 주문, 예약, 35개국어 지원. 수수료 및 개발자 필요 없음." },
    dynamicHeadlines: ["수수료 0%.", "35개국어 (AI).", "온라인 주문.", "24/7 예약 시스템.", "프리미엄 디자인."],
