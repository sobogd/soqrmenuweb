...
export const TEXTS: LandingTexts = {
  ...
  features: {
    ...
    items: [
      { Icon: ScanLine, title: "모든 주문의 100%를 가져가세요", desc: "손님이 스캔하고 주문하고 결제 — 바로 당신에게. 앱 다운로드 없음, 30% 배달 몫 없음. 모든 주문이 테이블 번호와 함께 실시간으로 대시보드에 도착합니다." },
      { Icon: Languages, title: "관광객에게 그들의 언어로 판매", desc: "한 번 터치로 전체 메뉴를 35개 언어로 번역. AI가 음식의 맥락을 이해 — 손님은 음식을 진짜 이해할 때 더 많이 주문합니다." },
      { Icon: CalendarCheck, title: "요리 중에도 예약 놓치지 않기", desc: "손님이 24시간 예약, 전화 불필요. 자동 또는 수동 확인, 이메일 알림 포함 — 노쇼 감소, 스트레스 0." },
      { Icon: Palette, title: "1초 만에 잊을 수 없게", desc: "주방 영상이나 음식 사진을 메뉴 배경으로. 손님은 스크롤을 멈추고, 브랜드는 기억에 남습니다." },
      { Icon: Smartphone, title: "초 단위로 변경, 일 단위 아님", desc: "가격, 사진, 오늘의 메뉴 — 휴대폰에서, 테이블 사이에. 손님에게 즉시 반영. 다시는 인쇄 안 합니다." },
      { Icon: ListPlus, title: "카톡 보낼 줄 알면, 사용할 수 있어요", desc: "터치해서 메뉴 추가. 드래그해서 순서 변경. 품절은 끄기. 매뉴얼 없음, 튜토리얼 없음, 학습 곡선 없음." },
    ],
  },
  founder: {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "하나의 계정으로 여러 레스토랑을 관리할 수 있나요?", a: "네. Pro 플랜에서 같은 계정에 여러 레스토랑 — 별도 메뉴, 별도 QR, 별도 분석, 로그인 하나. 두 번 터치로 전환." },
  ...
  footer: {
    ...
    legalLinks: [
      { href: "/ko/terms", label: "이용약관" }, { href: "/ko/privacy", label: "개인정보" },
      { href: "/ko/cookies", label: "쿠키" }, { href: "/sitemap.xml", label: "사이트맵" },
    ],
