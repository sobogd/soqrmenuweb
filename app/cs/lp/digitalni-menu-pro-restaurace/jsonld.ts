...
const URL_SELF = "https://iq-rest.com/cs/lp/digitalni-menu-pro-restaurace";
const URL_HOME = "https://iq-rest.com/cs";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digitální menu pro restaurace",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digitální menu pro restaurace", item: URL_SELF },
    ],
  };
