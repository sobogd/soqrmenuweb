...
export const TEXTS: LandingTexts = {
  ...
  header: { navFeatures: "Funkce", navHow: "Jak to funguje", navPricing: "Ceny", navFaq: "FAQ", signIn: "Přihlásit", cta: "Zkusit zdarma" },
  hero: {
    verticals: ["Restaurace", "Kavárny", "Bary", "Hotely", "Pizzerie"],
    qr: { headline: "QR menu za 5 minut.", sub: "Hotová webová stránka pro vaši restauraci — bez programátorů a dodavatelů. Přímé objednávky, rezervace a analytika hostů v jednom předplatném." },
    web: { headline: "Web restaurace za 5 min.", sub: "Hotová webová stránka pro vaši restauraci — bez programátorů a dodavatelů. Přímé objednávky, rezervace a analytika hostů v jednom předplatném." },
