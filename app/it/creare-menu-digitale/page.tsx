...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og/creare-menu-digitale.png",
        width: 1200,
        height: 630,
        alt: "Creare Menu Digitale per Ristoranti — IQ Rest",
      },
    ],
  },
  twitter: {
    ...
    title: TEXTS.meta.ogTitle,
    description: TEXTS.meta.ogDescription,
    images: ["/og/creare-menu-digitale.png"],
  },
};

export default async function CreareMenuDigitaleLanding() {
