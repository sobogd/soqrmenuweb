...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "QR meni za vašo restavracijo v 5 minutah.", sub: "Neposredna naročila, rezervacije in 35 jezikov. Brez provizij in programerjev." },
    web: { headline: "Profesionalna spletna stran restavracije v 5 minutah.", sub: "Neposredna naročila, rezervacije in 35 jezikov. Brez provizij in programerjev." },
