...
export const TEXTS: FeatureTexts = {
  meta: {
    title: "Traducció de menú per IA per a restaurant — 35 idiomes, un sol toc",
    description:
      "Tradueix tot el menú del teu restaurant a 35 idiomes amb una IA que entén el context culinari. Un toc, resultats a l'instant. 14 dies gratis, sense targeta.",
    canonical: "https://iq-rest.com/ca/ai-translation",
    ogLocale: "ca_ES",
    ogTitle: "Traducció de menú per IA — Tradueix el menú del teu restaurant a 35 idiomes",
    ogDescription:
      "Els turistes demanen més quan entenen el menú. Traducció per IA pensada per a la gastronomia — preserva noms de plats, encerta les descripcions, llesta a l'instant.",
  },

  hero: {
    title: "Els turistes no entenen el teu menú? Arregla-ho amb un toc.",
    subtitle:
  ...
  pricing: {
    heading: "Un sol pla.",
    headingAccent: "35 idiomes inclosos.",
    sub: "Traducció per IA, menú QR, comandes en línia i reserves — tot inclòs en un únic preu fix. Sense costos per idioma, sense costos per traducció, mai.",
  },

  faq: {
    sub: "Tot el que els restauradors pregunten sobre la traducció de menús. No hi veus la teva? Escriu-nos per WhatsApp — responen persones reals.",
    items: [
      {
        q: "Quina precisió té la IA comparada amb Google Translate?",
        a: "Molt millor per al menjar. Google Translate no sap que 'pulpo a la gallega' no s'ha de traduir paraula per paraula, o que 'amuse-bouche' es queda en francès en un menú de fine dining. La nostra IA s'ha entrenat amb menús reals de restaurants i sap quan traduir, quan transliterar i quan mantenir l'original. També pots editar qualsevol traducció a mà — útil per a grafies regionals.",
      },
      {
        q: "Quants idiomes admeteu?",
        a: "35 idiomes de sèrie: anglès, espanyol, alemany, francès, italià, portuguès, neerlandès, polonès, txec, eslovac, hongarès, romanès, búlgar, croat, serbi, eslovè, grec, turc, rus, ucraïnès, lituà, letó, estonià, finès, suec, noruec, danès, islandès, català, gaèlic irlandès, àrab, persa, japonès, coreà i xinès. Les grafies de dreta a esquerra com l'àrab i el persa es renderitzen correctament sense configuració.",
      },
      {
        q: "He de traduir-ho tot manualment primer?",
        a: "No. Escriu el menú en la teva llengua, fes clic a 'tradueix', tria els idiomes que vulguis — la IA fa la resta. Pots revisar i editar qualsevol traducció, però no hi estàs obligat. La majoria de restaurants ho configuren un cop i se n'obliden.",
      },
      {
        q: "Què passa quan afegeixo un plat nou?",
        a: "Es tradueix automàticament a tots els idiomes que tinguis activats. Afegeixes 'Risotto de tòfona' en català amb una descripció, prems desar i en segons el plat apareix traduït a tots els idiomes actius. Sense reexecutar res, sense processos per lots.",
      },
      {
        q: "Els clients poden canviar d'idioma al menú?",
        a: "Sí. El menú QR té un selector d'idioma a la part superior — els clients toquen una bandera i tot el menú es torna a renderitzar en la seva llengua. O pots deixar la detecció automàtica a partir de la configuració del mòbil, perquè un turista francès que escaneja el teu QR vegi francès immediatament. Sense botons per cercar, sense fricció.",
      },
    ],
  },

  finalCta: {
    heading: "Els turistes el poden llegir.",
    headingAccent: "Els turistes demanen més.",
    sub: "Tradueix el teu menú a 35 idiomes amb un clic. 14 dies gratis. Sense targeta. Sense costos per idioma, mai.",
  },
};
