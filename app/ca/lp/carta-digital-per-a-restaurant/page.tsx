...
export const metadata: Metadata = {
  ...
  // Noindex: /ca carries the organic SEO; this URL exists purely as a
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Carta Digital per a Restaurant — IQ Rest",
      },
    ],
  },
  twitter: {
...
export default function CartaDigitalPerARestaurantLpLanding() {
  return (
