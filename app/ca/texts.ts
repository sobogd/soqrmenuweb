...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "Carta QR en 5 minuts.", sub: "Lloc web llest per al teu restaurant — sense programadors ni contractistes. Comandes directes, reserves i analítica de clients en una sola subscripció." },
    web: { headline: "Web de restaurant en 5 min.", sub: "Lloc web llest per al teu restaurant — sense programadors ni contractistes. Comandes directes, reserves i analítica de clients en una sola subscripció." },
