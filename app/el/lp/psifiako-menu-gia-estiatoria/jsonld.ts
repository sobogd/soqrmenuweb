...
const URL_SELF = "https://iq-rest.com/el/lp/psifiako-menu-gia-estiatoria";
const URL_HOME = "https://iq-rest.com/el";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Ψηφιακό μενού για εστιατόρια",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Ψηφιακό μενού για εστιατόρια", item: URL_SELF },
    ],
  };
