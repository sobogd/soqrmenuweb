...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...DEFAULT.hero,
    headline: "QR μενού για εστιατόρια. Έτοιμο σε 5 λεπτά.",
    sub: "QR μενού για το εστιατόριό σας σε 5 λεπτά. Όλα συμπεριλαμβάνονται: επεξεργαστής για κινητό χωρίς κώδικα, σάρωση μενού με AI, κωδικοί QR για τραπέζια και άμεσες παραγγελίες χωρίς προμήθειες.",
    dynamicHeadlines: [],
