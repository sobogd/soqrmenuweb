...
const HOME_HERO = {
  title: "Όλα όσα χρειάζεται το εστιατόριό σας.",
  titleAccent: "Σε μία πλατφόρμα.",
  sub: "Μενού, παραγγελίες, κρατήσεις, οθόνη κουζίνας και μετάφραση AI — μία πλατφόρμα αντί για πέντε ξεχωριστές υπηρεσίες. Επιλέξτε μια δυνατότητα παρακάτω για να μάθετε περισσότερα.",
  imageAlt: "Ένας πελάτης φιλτράρει το μενού QR ανά αλλεργιογόνα στο κινητό ενώ ο ιδιοκτήτης επεξεργάζεται τη λίστα από tablet",
};

const FEATURE_IMAGES: Record<string, string> = {
  "Ψηφιακό μενού": "/landing/hero-cafe.webp",
  "Παραγγελίες": "/landing/feature-orders.webp",
  "Κρατήσεις": "/landing/feature-reservation.webp",
