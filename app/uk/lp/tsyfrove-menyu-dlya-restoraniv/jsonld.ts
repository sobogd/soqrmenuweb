...
const URL_SELF = "https://iq-rest.com/uk/lp/tsyfrove-menyu-dlya-restoraniv";
const URL_HOME = "https://iq-rest.com/uk";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Цифрове меню для ресторанів",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Цифрове меню для ресторанів", item: URL_SELF },
    ],
  };
