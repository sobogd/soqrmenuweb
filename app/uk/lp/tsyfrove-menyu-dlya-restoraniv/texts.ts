...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    headline: "Цифрове меню для ресторанів. Готове за 5 хвилин.",
    sub: "Цифрове меню для твого ресторану за 5 хвилин. Все включено: мобільний редактор без коду, AI-сканування меню, QR-коди для столиків і прямі замовлення без комісій.",
    dynamicHeadlines: [],
  },
