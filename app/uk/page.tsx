...
const HOME_HERO = {
  title: "Усе, що потрібно Вашому ресторану. На одній платформі.",
  sub: "Меню, прийом замовлень, бронювання, кухонний дисплей та AI-переклад — одна платформа замість п'яти окремих сервісів. Оберіть функцію нижче, щоб дізнатися більше.",
  exploreCta: "Усі функції",
};

const FEATURE_IMAGES: Record<string, string> = {
  "Цифрове меню": "/landing/hero-cafe.webp",
  "Замовлення": "/landing/feature-orders.webp",
  "Бронювання": "/landing/feature-reservation.webp",
