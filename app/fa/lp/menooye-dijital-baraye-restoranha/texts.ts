...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    headline: "منوی دیجیتال برای رستوران‌ها",
    sub: "بیش از ۵۰۰ رستوران در ۳۰+ کشور میزهای بیشتری سرو می‌کنند، به گردشگران بیشتر می‌فروشند و کمیسیون تحویل را حذف می‌کنند. در ۵ دقیقه آماده — ۱۴ روز رایگان.",
    verticals: ["سفارش آنلاین", "رزرو", "ترجمه هوش مصنوعی", "اسکنر منو", "آلرژن‌ها", "طراحی پریمیوم", "تحلیل‌ها"],
    dynamicHeadlines: [],
    headlinePrefix: "منوی دیجیتال برای ",
    accentWord: "رستوران‌ها",
    accentWordRotation: ["رستوران‌ها", "کافه‌ها", "بارها", "پیتزافروشی‌ها", "بیسترو", "پاب‌ها"],
    headlineSuffix: "",
  },
