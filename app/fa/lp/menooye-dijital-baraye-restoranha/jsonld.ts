...
const URL_SELF = "https://iq-rest.com/fa/lp/menooye-dijital-baraye-restoranha";
const URL_HOME = "https://iq-rest.com/fa";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — منوی دیجیتال برای رستوران‌ها",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "منوی دیجیتال برای رستوران‌ها", item: URL_SELF },
    ],
  };
