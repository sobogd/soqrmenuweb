...
const URL_SELF = "https://iq-rest.com/pl/lp/cyfrowe-menu-dla-restauracji";
const URL_HOME = "https://iq-rest.com/pl";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Cyfrowe menu dla restauracji",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Cyfrowe menu dla restauracji", item: URL_SELF },
    ],
  };
