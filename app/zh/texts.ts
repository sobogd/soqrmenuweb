...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "5分钟创建QR菜单。", sub: "直接下单、预订和 35 种语言。无佣金，无需程序员。" },
    web: { headline: "5分钟上线餐厅网站。", sub: "直接下单、预订和 35 种语言。无佣金，无需程序员。" },
    dynamicHeadlines: ["0 佣金。", "35 种语言 (AI)。", "在线下单。", "24/7 预订。", "高档设计。"],
