...
const URL_SELF = "https://iq-rest.com/zh/lp/restaurant-digital-menu-chinese";
const URL_HOME = "https://iq-rest.com/zh";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "餐厅数字菜单", item: URL_SELF },
    ],
  };
