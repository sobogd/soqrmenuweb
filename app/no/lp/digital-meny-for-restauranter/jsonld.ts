...
const URL_SELF = "https://iq-rest.com/no/lp/digital-meny-for-restauranter";
const URL_HOME = "https://iq-rest.com/no";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digital meny for restauranter",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digital meny for restauranter", item: URL_SELF },
    ],
  };
