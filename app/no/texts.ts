...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "QR-meny til din restaurant på 5 minutter.", sub: "Direkte bestillinger, booking og 35 språk. Ingen provisjon eller koding." },
    web: { headline: "Profesjonell restaurant-nettside på 5 minutter.", sub: "Direkte bestillinger, booking og 35 språk. Ingen provisjon eller koding." },
