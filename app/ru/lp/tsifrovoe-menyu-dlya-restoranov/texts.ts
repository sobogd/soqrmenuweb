...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    headline: "Цифровое меню для ресторанов",
    sub: "500+ ресторанов в 30+ странах обслуживают больше столов, продают больше туристам и убирают комиссии доставки. Запуск за 5 минут — 14 дней бесплатно.",
    verticals: ["Онлайн-заказы", "Бронирования", "AI-перевод", "Сканер меню", "Аллергены", "Премиум-дизайн", "Аналитика"],
    dynamicHeadlines: [],
    headlinePrefix: "Цифровое меню для ",
    accentWord: "ресторанов",
    accentWordRotation: ["ресторанов", "кафе", "баров", "пиццерий", "бистро", "пабов"],
    headlineSuffix: "",
  },
