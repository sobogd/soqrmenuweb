...
const URL_SELF = "https://iq-rest.com/ru/lp/tsifrovoe-menyu-dlya-restoranov";
const URL_HOME = "https://iq-rest.com/ru";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Цифровое меню для ресторанов",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Цифровое меню для ресторанов", item: URL_SELF },
    ],
  };
