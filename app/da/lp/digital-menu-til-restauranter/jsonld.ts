...
const URL_SELF = "https://iq-rest.com/da/lp/digital-menu-til-restauranter";
const URL_HOME = "https://iq-rest.com/da";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digital menu til restauranter",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digital menu til restauranter", item: URL_SELF },
    ],
  };
