...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "QR-menu til din restaurant på 5 minutter.", sub: "Direkte bestillinger, reservationer og 35 sprog. Ingen provision eller programmører." },
    web: { headline: "Professionel restaurant-hjemmeside på 5 minutter.", sub: "Direkte bestillinger, reservationer og 35 sprog. Ingen provision eller programmører." },
