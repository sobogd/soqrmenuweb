...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    headline: "QR-menu på 5 minutter.",
    sub: "Færdig restaurantwebsite — uden udviklere og underleverandører. Direkte bestillinger, reservationer og gæsteanalyse i ét abonnement.",
