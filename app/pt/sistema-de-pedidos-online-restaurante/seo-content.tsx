    ...
    <>
      <Section dataSection="seo-intro">
        <div className="max-w-4xl mx-auto">
          <p className="text-xs font-medium uppercase tracking-widest text-primary mb-3 text-center">Em detalhe</p>
      ...
      <Section dataSection="seo-benefits">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl sm:text-3xl font-medium tracking-tight mb-6 text-center">O que recebes</h3>
      ...
      <Section dataSection="seo-how">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl sm:text-3xl font-medium tracking-tight mb-6 text-center">Como funciona o fluxo de pedidos IQ Rest</h3>
          <p className="text-base sm:text-lg text-foreground/90 leading-relaxed mb-6 text-center">Quatro interruptores no painel e estás ao vivo. Sem instalador, sem hardware POS, sem projeto de integração.</p>
      ...
      <Section dataSection="seo-table">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl sm:text-3xl font-medium tracking-tight mb-6 text-center">Agregador, POS clássico ou sistema de pedidos</h3>
