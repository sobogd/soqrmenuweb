...
const URL_SELF = "https://iq-rest.com/pt/lp/menu-digital-para-restaurantes";
const URL_HOME = "https://iq-rest.com/pt";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Menu digital para restaurantes",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Menu digital para restaurantes", item: URL_SELF },
    ],
  };
