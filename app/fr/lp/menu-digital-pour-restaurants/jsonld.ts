...
const URL_SELF = "https://iq-rest.com/fr/lp/menu-digital-pour-restaurants";
const URL_HOME = "https://iq-rest.com/fr";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Menu digital pour restaurants",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Menu digital pour restaurants", item: URL_SELF },
    ],
  };
