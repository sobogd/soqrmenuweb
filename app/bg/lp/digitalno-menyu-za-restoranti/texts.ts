...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    headline: "Дигитално меню за ресторанти. Готово за 5 минути.",
    sub: "Дигитално меню за вашия ресторант за 5 минути. Всичко включено: мобилен редактор без код, AI сканиране на менюто, QR кодове за маси и директни поръчки без комисиони.",
    dynamicHeadlines: [],
  },
