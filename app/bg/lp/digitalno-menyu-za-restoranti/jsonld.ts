...
const URL_SELF = "https://iq-rest.com/bg/lp/digitalno-menyu-za-restoranti";
const URL_HOME = "https://iq-rest.com/bg";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Дигитално меню за ресторанти",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Дигитално меню за ресторанти", item: URL_SELF },
    ],
  };
