...
const HOME_HERO = {
  title: "Всичко необходимо за вашия ресторант.",
  titleAccent: "На една платформа.",
  sub: "Меню, приемане на поръчки, резервации, кухненски дисплей и ИИ превод — една платформа вместо пет отделни услуги. Изберете функция отдолу за повече подробности.",
  imageAlt: "Гост филтрира QR менюто по алергени на телефона, докато собственикът редактира списъка от таблет",
};

const FEATURE_IMAGES: Record<string, string> = {
  "Дигитално меню": "/landing/hero-cafe.webp",
  "Поръчки": "/landing/feature-orders.webp",
  "Резервации": "/landing/feature-reservation.webp",
