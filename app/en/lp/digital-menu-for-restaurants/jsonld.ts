...
const URL_SELF = "https://iq-rest.com/en/lp/digital-menu-for-restaurants";
const URL_HOME_EN = "https://iq-rest.com/en";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digital Menu for Restaurants",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Digital Menu for Restaurants",
        item: URL_SELF,
      },
    ],
  };
