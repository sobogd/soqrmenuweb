...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "QR ēdienkarte jūsu restorānam 5 minūtēs.", sub: "Tiešie pasūtījumi, rezervācijas un 35 valodas. Bez komisijas un programmētājiem." },
    web: { headline: "Profesionāla restorāna mājaslapa 5 minūtēs.", sub: "Tiešie pasūtījumi, rezervācijas un 35 valodas. Bez komisijas un programmētājiem." },
