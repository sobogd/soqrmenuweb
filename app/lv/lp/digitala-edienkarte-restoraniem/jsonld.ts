...
const URL_SELF = "https://iq-rest.com/lv/lp/digitala-edienkarte-restoraniem";
const URL_HOME = "https://iq-rest.com/lv";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digitālā ēdienkarte restorāniem",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digitālā ēdienkarte restorāniem", item: URL_SELF },
    ],
  };
