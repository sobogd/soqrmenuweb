...
export const CRO: CroCopy = {
  ...
  benefits: [
    ...
    { Icon: Receipt, tag: "الطلب على الطاولة", title: "الطلبات مباشرة إلى المطبخ.", bullets: ["الضيف أو النادل","مباشرة إلى المطبخ","شغّله متى شئت"], image: "/landing/feature-orders.webp", imageAlt: "نادل يأخذ طلبًا على الطاولة من الهاتف، فيصل إلى شاشة المطبخ" },
  ],
