...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    sub: "أكثر من 500 مطعم في 30+ دولة يخدمون المزيد من الطاولات، ويبيعون أكثر للسياح، ويلغون عمولات التوصيل. على الإنترنت خلال 5 دقائق — 14 يوماً مجاناً.",
    verticals: ["طلبات أونلاين", "حجوزات", "ترجمة بالذكاء الاصطناعي", "ماسح القائمة", "المواد المسببة للحساسية", "تصميم بريميوم", "تحليلات"],
    dynamicHeadlines: [],
    headlinePrefix: "قائمة طعام رقمية ",
    accentWord: "للمطاعم",
    accentWordRotation: ["للمطاعم", "للمقاهي", "للبارات", "لمحلات البيتزا", "للبيسترو", "للحانات"],
    headlineSuffix: "",
  },
