...
const URL_SELF = "https://iq-rest.com/ar/lp/qaimat-taam-raqmiya-lilmataem";
const URL_HOME = "https://iq-rest.com/ar";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — قائمة طعام رقمية للمطاعم",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "قائمة طعام رقمية للمطاعم", item: URL_SELF },
    ],
  };
