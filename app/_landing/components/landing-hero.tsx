...
export function LandingHero({
  ...
  return (
    <section
      data-section="hero"
      className="relative w-full min-h-[100svh] overflow-hidden flex flex-col text-white"
    >
      <Image
        src={imageSrc}
        alt={imageAlt}
      ...
      <div className="relative flex-1 flex flex-col justify-end w-full px-4 sm:px-6 lg:px-10 xl:px-14 pb-12 sm:pb-16 lg:pb-20">
        <div className="w-full max-w-3xl lg:max-w-[65%]">
          ...
          <div className="h-[5px] w-20 rounded-full bg-gradient-to-r from-[hsl(9,100%,58%)] to-[hsl(35,95%,55%)] mb-6" />
        ...
        <div className="flex flex-col items-start sm:flex-row sm:items-center gap-3 w-full mt-8">
          <button
            type="button"
        ...
        {microcopy ? <p className="mt-4 text-sm text-white/65">{microcopy}</p> : null}
      </div>
    </section>
  );
}
