...
const COPY: Record<string, LocaleCopy> = {
  ...
  ru: {
    reservation: {
      alt: "Хостес управляет бронями с планшета у входа в ресторан",
      eyebrow: "Бронирования",
      heading: "Заполняй зал, пока ты на кухне.",
      body: "Брони онлайн 24/7 сразу в твой календарь. Никаких звонков, никакой бумаги.",
      bullets: [
        "Календарь по столам и слотам.",
        "Автоподтверждения и напоминания.",
        "Бронь по QR со стола или из меню.",
      ],
    },
    orders: {
      alt: "Официант принимает заказ за столиком со смартфона с приложением",
      eyebrow: "Заказы в зале",
      heading: "Официант принимает заказ. Прямо на кухню.",
      body: "Без блокнота, без беготни к бару. Тыкаешь стол, отмечаешь блюда — готово.",
      bullets: [
        "Визуальная карта столов вживую.",
        "Заказ мгновенно на кухню и в кассу.",
        "Модификаторы, заметки и аллергены на каждое блюдо.",
      ],
    },
    kitchen: {
      alt: "Профессиональная кухня с планшетом на латунной подставке с экраном кухни",
      eyebrow: "Дисплей кухни",
      heading: "С телефона гостя — прямо на экран повара.",
      body: "Прощай, бумажные чеки. Заказы по столам, с заметками и аллергенами, готовы к приготовлению.",
      bullets: [
        "Колонки по столам: Готово / Готовится / Подано.",
        "Аллергены и заметки выделены на каждом блюде.",
        "Зал, кухня и касса синхронизированы в реалтайме.",
      ],
    },
    multilang: {
      alt: "Два гостя читают одно и то же цифровое меню на разных языках с телефонов",
      eyebrow: "35 языков с ИИ",
      heading: "Один QR. Каждый гость — на своём языке.",
      body: "Переведи всё меню на 35 языков в один тап. ИИ понимает гастрономию.",
      bullets: [
        "35 языков включено. Без доплат.",
        "Кулинарный контекст, а не Google Translate.",
        "Язык гостя определяется автоматически.",
      ],
    },
    mobile: {
      alt: "Ноутбук и телефон на столике кафе — редактируют одно и то же блюдо в дашборде",
      eyebrow: "Управление с мобильного",
      heading: "Всё твоё меню — в кармане.",
      body: "Та же панель на ноутбуке, планшете и телефоне. Правки вживую за секунды.",
      bullets: [
        "Без приложения — открой браузер.",
        "Цены и фото в один тап.",
        "Работай откуда угодно.",
      ],
    },
  },
