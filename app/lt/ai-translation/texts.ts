...
export const TEXTS: FeatureTexts = {
  meta: {
    title: "DI restorano meniu vertimas — 35 kalbos, vienas bakstelėjimas",
    description:
      "Išverskite visą savo restorano meniu į 35 kalbas su DI, kuris supranta kulinarinį kontekstą. Vienas bakstelėjimas — momentiniai rezultatai. 14 dienų nemokamas bandymas, be kreditinės kortelės.",
    canonical: "https://iq-rest.com/lt/ai-translation",
    ogLocale: "lt_LT",
    ogTitle: "DI meniu vertimas — išverskite restorano meniu į 35 kalbas",
    ogDescription:
      "Turistai užsako daugiau, kai supranta meniu. DI vertimas, sukurtas maistui — išsaugo patiekalų pavadinimus, teisingai surašo aprašymus, paruoštas iškart.",
  },
  ...
  pricing: {
    ...
    headingAccent: "35 kalbos įtrauktos.",
    sub: "DI vertimas, QR meniu, internetiniai užsakymai ir rezervacijos — viskas vienoje fiksuotoje kainoje. Jokių mokesčių už kalbą ar vertimą, niekada.",
  },

  faq: {
    sub: "Viskas, ko restoranų savininkai klausia apie meniu vertimą. Nematote savo? Parašykite mums per WhatsApp — atsako tikri žmonės.",
    items: [
      {
        q: "Kiek tikslus DI lyginant su Google Translate?",
        a: "Daug geresnis maistui. Google Translate nežino, kad „pulpo a la gallega“ neturėtų būti verčiamas pažodžiui, ar kad „amuse-bouche“ lieka prancūzų kalba aukšto lygio meniu. Mūsų DI buvo apmokytas pagal tikrų restoranų meniu ir žino, kada versti, kada transliteruoti ir kada palikti originalą. Taip pat galite redaguoti bet kurį vertimą rankiniu būdu — naudinga regioninei rašybai.",
      },
      {
        q: "Kiek kalbų palaikote?",
      ...
      {
        q: "Ar pirmiausia turiu viską išversti rankiniu būdu?",
        a: "Ne. Parašykite meniu gimtąja kalba, paspauskite „versti“, pasirinkite norimas kalbas — DI padaro likusį darbą. Galite peržiūrėti ir redaguoti bet kurį vertimą, bet to daryti nereikia. Daugumai restoranų pakanka vieną kartą nustatyti ir pamiršti.",
      },
      {
        q: "Kas atsitinka, kai pridedu naują patiekalą?",
        a: "Jis automatiškai išverčiamas į kiekvieną įjungtą kalbą. Pridedate „Triufelių rizotą“ lietuviškai su aprašymu, paspaudžiate išsaugoti, ir per kelias sekundes patiekalas pasirodo išverstas visomis aktyviomis kalbomis. Be jokių paleidimų iš naujo, be paketinių užduočių.",
      },
      {
        q: "Ar svečiai gali pakeisti kalbą meniu?",
        a: "Taip. QR meniu viršuje yra kalbos pasirinkimas — svečiai bakstelėja vėliavą, ir visas meniu pertvarkomas jų kalba. Arba galite leisti automatiškai aptikti pagal jų telefono kalbos nustatymus, kad prancūzų turistas, nuskaitęs jūsų QR, iškart matytų prancūziškai. Jokių mygtukų, jokio trinties.",
      },
    ],
  },

  finalCta: {
    heading: "Turistai gali tai perskaityti.",
    headingAccent: "Turistai užsako daugiau.",
    sub: "Išverskite meniu į 35 kalbas vienu paspaudimu. 14 dienų nemokamas bandymas. Be kreditinės kortelės. Jokių mokesčių už kalbą, niekada.",
  },
};
