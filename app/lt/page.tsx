...
const HOME_HERO = {
  title: "Viskas, ko reikia jūsų restoranui. Vienoje platformoje.",
  ...
  exploreCta: "Visos funkcijos",
};

const FEATURE_IMAGES: Record<string, string> = {
  "Skaitmeninis meniu": "/landing/hero-cafe.webp",
  "Užsakymai": "/landing/feature-orders.webp",
