...
const URL_SELF = "https://iq-rest.com/lt/lp/skaitmeninis-meniu-restoranams";
const URL_HOME = "https://iq-rest.com/lt";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Skaitmeninis meniu restoranams",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Skaitmeninis meniu restoranams", item: URL_SELF },
    ],
  };
