...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "QR matseðill á 5 mínútum.", sub: "Tilbúinn vefur fyrir veitingastaðinn — án forritara og verktaka. Beinar pantanir, bókanir og gestagreining í einum áskriftarpakka." },
    web: { headline: "Vefsíða staðarins á 5 mín.", sub: "Tilbúinn vefur fyrir veitingastaðinn — án forritara og verktaka. Beinar pantanir, bókanir og gestagreining í einum áskriftarpakka." },
