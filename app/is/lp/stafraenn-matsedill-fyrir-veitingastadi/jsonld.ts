...
const URL_SELF = "https://iq-rest.com/is/lp/stafraenn-matsedill-fyrir-veitingastadi";
const URL_HOME = "https://iq-rest.com/is";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Stafrænn matseðill fyrir veitingastaði",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Stafrænn matseðill fyrir veitingastaði", item: URL_SELF },
    ],
  };
