...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    web: { headline: "Web de restaurante\nen 5 min.", sub: "Sitio web listo para tu restaurante — sin programadores ni contratistas. Pedidos directos, reservas y analítica de clientes en una sola suscripción." },
