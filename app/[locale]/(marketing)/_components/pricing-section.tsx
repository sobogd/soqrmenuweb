...
function PriceDisplay({ parts, perMonth }: { parts: ReturnType<typeof formatPriceParts>; perMonth: string }) {
  ...
  return (
    <div className="leading-none">
      ...
      <span className="text-sm text-muted-foreground font-medium mt-0.5 mb-2 inline-block">{perMonth}</span>
    </div>
  );
}
  ...
  const content = (
    <div className="container mx-auto px-4 py-16 md:py-24">
      <div className="max-w-3xl mx-auto text-center space-y-6">
        {/* Badge */}
        <div className="inline-flex items-center rounded-xl border border-border bg-muted/50 px-3 py-1 text-sm font-medium text-muted-foreground">
          {t("badge")}
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 w-full mb-4">
          ...
          >
            <div className="shrink-0">
              <p className="text-sm font-bold uppercase tracking-widest text-muted-foreground mb-3 lg:mb-1">
                {t("monthly")}
              </p>
          ...
          >
            <div className="shrink-0">
              <p className="text-sm font-bold uppercase tracking-widest text-primary mb-3 lg:mb-1">
                {t("yearly")}
              </p>
