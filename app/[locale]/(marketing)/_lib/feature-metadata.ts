...
export const FEATURE_METADATA = {
  en: {
    "instant-setup": {
      title: "Instant QR Menu & Restaurant Website Setup | Create in 5 Minutes - GrandQR",
    ...
    "mobile-management": {
      title: "Mobile Restaurant Menu Management | Manage QR Menu from Phone - GrandQR",
    ...
    "ai-translation": {
      title: "AI Menu Translation for Restaurants | Multilingual QR Menu - GrandQR",
    ...
    multilingual: {
      title: "Multilingual Restaurant Website | Multi-Language QR Menu - GrandQR",
    ...
    "ai-images": {
      title: "AI Image Optimization for Restaurant Menu | Fast Loading Photos - GrandQR",
    ...
    "easy-menu": {
      title: "Easy Restaurant Menu Management | Drag & Drop Menu Editor - GrandQR",
    ...
    analytics: {
      title: "Restaurant Menu Analytics | QR Menu Statistics & Insights - GrandQR",
    ...
    reservations: {
      title: "Online Table Reservations for Restaurants | Booking System - GrandQR",
    ...
    "custom-design": {
      title: "Video & Photo Backgrounds for Restaurant Website - GrandQR",
    ...
    "color-scheme": {
      title: "Custom Color Scheme for Restaurant Website | Brand Colors - GrandQR",
    ...
    "personal-support": {
      title: "Personal Support for Restaurant QR Menu | Real Human Help - GrandQR",
  ...
  es: {
    "instant-setup": {
      title: "Configuración Instantánea de Menú QR y Sitio Web de Restaurante | Crear en 5 Minutos - GrandQR",
    ...
    "mobile-management": {
      title: "Gestión de Menú de Restaurante Móvil | Administrar Menú QR desde Teléfono - GrandQR",
    ...
    "ai-translation": {
      title: "Traducción de Menú con IA para Restaurantes | Menú QR Multilingüe - GrandQR",
    ...
    multilingual: {
      title: "Sitio Web de Restaurante Multilingüe | Menú QR Multi-Idioma - GrandQR",
    ...
    "ai-images": {
      title: "Optimización de Imágenes con IA para Menú de Restaurante - GrandQR",
    ...
    "easy-menu": {
      title: "Gestión Fácil de Menú de Restaurante | Editor Arrastrar y Soltar - GrandQR",
    ...
    analytics: {
      title: "Análisis de Menú de Restaurante | Estadísticas e Información de Menú QR - GrandQR",
    ...
    reservations: {
      title: "Reservaciones de Mesa Online para Restaurantes | Sistema de Reservas - GrandQR",
    ...
    "custom-design": {
      title: "Fondos de Video y Foto para Sitio Web de Restaurante - GrandQR",
    ...
    "color-scheme": {
      title: "Esquema de Colores Personalizado para Sitio Web de Restaurante - GrandQR",
    ...
    "personal-support": {
      title: "Soporte Personal para Menú QR de Restaurante | Ayuda Humana Real - GrandQR",
