...
export const CRO: CroCopy = {
  ...
  benefits: [
    { Icon: Languages, tag: "デジタルメニュー", title: "PDFではなく、ウェブサイトのようなメニュー。", bullets: ["AIで35言語","上質なデザイン","価格を即時更新"], image: "/landing/feature-design.webp", imageAlt: "カフェのテーブルに2台のスマホ：デジタルメニューのウェルカム画面と地図付きの連絡先ページ" },
    { Icon: ChefHat, tag: "キッチンディスプレイ", title: "厨房が、ついにペーパーレスに。", bullets: ["画面にリアルタイム","メモとアレルゲン","タブレットかスマホ"], image: "/landing/feature-kds-cards.webp", imageAlt: "カウンターのタブレットがテーブルごとの注文とともにキッチンディスプレイを表示" },
    { Icon: CalendarCheck, tag: "予約", title: "自動で埋まるテーブル、24/7。", bullets: ["セルフ予約","自動確認","テーブル別カレンダー"], image: "/landing/feature-booking-calendar.webp", imageAlt: "2台のタブレットが予約カレンダーを表示：テーブル別の日次ビューと月次ビュー" },
    { Icon: Receipt, tag: "テーブルで注文", title: "メモ帳なしで注文を——オプション。", bullets: ["お客様かスタッフ","厨房へ直接","いつでもオン/オフ"], image: "/landing/feature-orders.webp", imageAlt: "スタッフがテーブルでスマホから注文を取り、キッチンディスプレイに届く" },
  ],
