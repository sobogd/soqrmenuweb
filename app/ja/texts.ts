...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "5分でQRメニュー作成。", sub: "直接注文、予約、35言語対応。手数料なし、プログラマー不要。" },
    web: { headline: "5分でレストランサイト公開。", sub: "直接注文、予約、35言語対応。手数料なし、プログラマー不要。" },
    dynamicHeadlines: ["手数料0%。", "35言語対応 (AI)。", "オンライン注文。", "24時間予約受付。", "高級感あるデザイン。"],
