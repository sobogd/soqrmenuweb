...
export const TEXTS: LandingTexts = {
  ...
  features: {
    ...
    items: [
      { Icon: ScanLine, title: "全注文の100%を自分のものに", desc: "お客様がスキャン、注文、支払い — 直接あなたへ。アプリのダウンロード不要、配達手数料30%もなし。すべての注文が卓番付きでリアルタイムにダッシュボードへ届きます。", tag: "直接注文" },
      { Icon: Languages, title: "観光客に彼らの言葉で売る", desc: "ワンタップでメニュー全部を35言語へ翻訳。AIが料理の文脈を理解 — 料理を本当に理解した時、お客様は注文を増やします。", tag: "AI翻訳" },
      { Icon: CalendarCheck, title: "調理中も予約を逃さない", desc: "お客様が24時間予約、電話不要。自動または手動確認、メールリマインダー込み — 無断キャンセル減、ストレスゼロ。", tag: "予約" },
      { Icon: Palette, title: "1秒で忘れられない印象", desc: "厨房の動画や料理の写真をメニュー背景に。お客様はスクロールを止め、ブランドが心に残ります。", tag: "カスタムデザイン" },
      { Icon: Smartphone, title: "数秒で更新、何日も待たない", desc: "価格、写真、本日のおすすめ — スマホから、テーブルの合間に。お客様には即時反映。再印刷は不要。", tag: "メニューエディタ" },
      { Icon: ChefHat, title: "毎シフト、より速くサービス", desc: "お客様が確定した瞬間、注文がキッチン画面に飛んできます。紙ゼロ、叫びゼロ、見落としゼロ — ミス減、回転速く、夜あたりの客数アップ。", tag: "近日公開" },
    ],
  },
  founder: {
