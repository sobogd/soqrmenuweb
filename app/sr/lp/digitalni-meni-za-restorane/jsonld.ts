...
const URL_SELF = "https://iq-rest.com/sr/lp/digitalni-meni-za-restorane";
const URL_HOME = "https://iq-rest.com/sr";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digitalni meni za restorane",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digitalni meni za restorane", item: URL_SELF },
    ],
  };
