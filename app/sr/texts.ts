...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "QR jelovnik za 5 minuta.", sub: "Готов сајт вашег ресторана — без програмера и извођача. Директне поруџбине, резервације и аналитика гостију у једној претплати." },
    web: { headline: "Veb-sajt za 5 minuta.", sub: "Готов сајт вашег ресторана — без програмера и извођача. Директне поруџбине, резервације и аналитика гостију у једној претплати." },
