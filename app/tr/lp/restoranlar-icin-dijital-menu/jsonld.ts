...
const URL_SELF = "https://iq-rest.com/tr/lp/restoranlar-icin-dijital-menu";
const URL_HOME = "https://iq-rest.com/tr";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Restoranlar için dijital menü",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Restoranlar için dijital menü", item: URL_SELF },
    ],
  };
