...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "5 dakikada QR Menü.", sub: "Restoranınız için hazır web sitesi — geliştirici ve yüklenici gerekmez. Doğrudan siparişler, rezervasyonlar ve misafir analizleri tek abonelikte." },
    web: { headline: "5 dakikada Restoran Sitesi.", sub: "Restoranınız için hazır web sitesi — geliştirici ve yüklenici gerekmez. Doğrudan siparişler, rezervasyonlar ve misafir analizleri tek abonelikte." },
