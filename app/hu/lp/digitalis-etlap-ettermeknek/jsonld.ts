...
const URL_SELF = "https://iq-rest.com/hu/lp/digitalis-etlap-ettermeknek";
const URL_HOME = "https://iq-rest.com/hu";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digitális étlap éttermeknek",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digitális étlap éttermeknek", item: URL_SELF },
    ],
  };
