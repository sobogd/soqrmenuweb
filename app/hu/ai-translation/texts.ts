...
export const TEXTS: FeatureTexts = {
  meta: {
    title: "AI éttermi étlap fordítás — 35 nyelv, egy koppintás",
    description:
      "Fordítsa le a teljes éttermi étlapját 35 nyelvre AI-val, amely érti a kulináris kontextust. Egy koppintás, azonnali eredmények. 14 napos ingyenes próba, bankkártya nélkül.",
    canonical: "https://iq-rest.com/hu/ai-translation",
    ogLocale: "hu_HU",
    ogTitle: "AI étlap fordítás — fordítsa le étterem étlapját 35 nyelvre",
    ogDescription:
      "A turisták többet rendelnek, ha értik az étlapot. Ételhez tervezett AI fordítás — megőrzi az ételneveket, helyesen kezeli a leírásokat, azonnal kész.",
  },
  ...
  pricing: {
    heading: "Egy csomag.",
    headingAccent: "35 nyelv benne.",
    sub: "AI fordítás, QR étlap, online rendelések és foglalások — minden egy fix árban. Nincsenek nyelvi díjak, nincsenek fordítási díjak, soha.",
  },

  faq: {
    sub: "Minden, amit étterem tulajdonosok kérdeznek az étlap fordításról. Nem látja a sajátját? Üzenjen nekünk WhatsApp-on — valódi emberek válaszolnak.",
    items: [
      {
        q: "Mennyire pontos az AI a Google Translate-hez képest?",
        a: "Sokkal jobb az ételhez. A Google Translate nem tudja, hogy a 'pulpo a la gallega'-t nem szóról szóra kell fordítani, vagy hogy az 'amuse-bouche' franciául marad egy fine-dining étlapon. AI-nkat valódi éttermi étlapokon képezték ki, és tudja, mikor kell fordítani, mikor átírni, és mikor megőrizni az eredetit. Bármelyik fordítást manuálisan is szerkesztheti — hasznos a regionális helyesíráshoz.",
      },
      {
        q: "Hány nyelvet támogatnak?",
        a: "35 nyelvet alapból: angol, spanyol, német, francia, olasz, portugál, holland, lengyel, cseh, szlovák, magyar, román, bolgár, horvát, szerb, szlovén, görög, török, orosz, ukrán, litván, lett, észt, finn, svéd, norvég, dán, izlandi, katalán, ír gael, arab, perzsa, japán, koreai és kínai. Az RTL írásrendszerek, mint az arab és a perzsa, alapból helyesen jelennek meg.",
      },
      {
        q: "Először mindent kézzel kell lefordítanom?",
        a: "Nem. Írja meg az étlapot anyanyelvén, kattintson a 'fordítás'-ra, válassza ki a kívánt nyelveket — az AI elvégzi a többit. Áttekintheti és szerkesztheti bármelyik fordítást, de nem kell. A legtöbb étterem egyszer beállítja és elfelejti.",
      },
      {
        q: "Mi történik, amikor új ételt adok hozzá?",
        a: "Automatikusan lefordítódik minden engedélyezett nyelvre. Hozzáad egy 'Szarvasgombás rizottó'-t magyarul leírással, mentésre kattint, és másodpercek alatt megjelenik az étel lefordítva minden aktív nyelven. Nincs újrafuttatás, nincsenek kötegelt feladatok.",
      },
      {
        q: "Tudnak a vendégek nyelvet váltani az étlapon?",
        a: "Igen. A QR étlap tetején van egy nyelvválasztó — a vendégek koppintanak egy zászlóra, és a teljes étlap újrarenderelődik a saját nyelvükön. Vagy hagyhatja, hogy automatikusan érzékelje a telefon nyelv beállításai alapján, így egy francia turista, aki beolvassa a QR-t, azonnal franciát lát. Nincsenek keresendő gombok, nincs súrlódás.",
      },
    ],
  },

  finalCta: {
    heading: "A turisták el tudják olvasni.",
    headingAccent: "A turisták többet rendelnek.",
    sub: "Fordítsa le étlapját 35 nyelvre egy kattintással. 14 napos ingyenes próba. Bankkártya nélkül. Soha nincsenek nyelvi díjak.",
  },
};
