...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: RouteConfig[] = [
    { path: '/pricing', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.9 },
    { path: '/instant-setup', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/mobile-management', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/ai-translation', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/multilingual', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/ai-images', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/easy-menu', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/analytics', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/reservations', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/custom-design', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/color-scheme', lastModified: '2026-02-20', changeFrequency: 'monthly', priority: 0.8 },
