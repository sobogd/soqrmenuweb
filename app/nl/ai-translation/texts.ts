...
export const TEXTS: FeatureTexts = {
  meta: {
    title: "AI restaurant menu vertaling — 35 talen, één tap",
    description:
      "Vertaal je hele restaurantmenu in 35 talen met AI die culinaire context begrijpt. Eén tap, directe resultaten. 14 dagen gratis proefperiode, geen creditcard.",
    canonical: "https://iq-rest.com/nl/ai-translation",
    ogLocale: "nl_NL",
    ogTitle: "AI menu vertaling — Vertaal je restaurantmenu in 35 talen",
    ogDescription:
      "Toeristen bestellen meer als ze het menu begrijpen. AI vertaling gebouwd voor eten — behoudt gerechtnamen, zet beschrijvingen goed, direct klaar.",
  },
  ...
  pricing: {
    heading: "Eén plan.",
    headingAccent: "35 talen inbegrepen.",
    sub: "AI vertaling, QR menu, online bestellen en reserveringen — alles inbegrepen in één vaste prijs. Geen kosten per taal, geen kosten per vertaling, ooit.",
  },

  faq: {
    sub: "Alles wat restauranthouders vragen over menu vertaling. Niet jouw vraag erbij? Stuur ons een bericht op WhatsApp — echte mensen antwoorden.",
    items: [
      {
        q: "Hoe nauwkeurig is de AI vergeleken met Google Translate?",
        a: "Veel beter voor eten. Google Translate weet niet dat « pulpo a la gallega » niet woord-voor-woord vertaald moet worden, of dat « amuse-bouche » in het Frans blijft op een fine-dining menu. Onze AI is getraind op echte restaurantmenu's en weet wanneer te vertalen, wanneer te transcriberen en wanneer het origineel te behouden. Je kunt ook elke vertaling handmatig bewerken — handig voor regionale spellingen.",
      },
      {
        q: "Hoeveel talen ondersteunen jullie?",
        a: "35 talen out-of-the-box: Engels, Spaans, Duits, Frans, Italiaans, Portugees, Nederlands, Pools, Tsjechisch, Slowaaks, Hongaars, Roemeens, Bulgaars, Kroatisch, Servisch, Sloveens, Grieks, Turks, Russisch, Oekraïens, Litouws, Lets, Ests, Fins, Zweeds, Noors, Deens, IJslands, Catalaans, Iers Gaelisch, Arabisch, Perzisch, Japans, Koreaans en Chinees. RTL-schriften zoals Arabisch en Perzisch worden out-of-the-box correct weergegeven.",
      },
      {
        q: "Moet ik eerst alles handmatig vertalen?",
        a: "Nee. Schrijf je menu in je moedertaal, klik op « vertalen », kies de talen die je wilt — de AI doet de rest. Je kunt elke vertaling controleren en bewerken, maar dat hoeft niet. De meeste restaurants stellen het één keer in en vergeten het.",
      },
      {
        q: "Wat gebeurt er als ik een nieuw gerecht toevoeg?",
        a: "Het vertaalt automatisch in elke ingeschakelde taal. Je voegt « Truffel risotto » toe in het Nederlands met een beschrijving, druk op opslaan, en binnen seconden verschijnt het gerecht vertaald in al je actieve talen. Geen herdraaien, geen batch jobs.",
      },
      {
        q: "Kunnen gasten van taal wisselen in het menu?",
  ...
  finalCta: {
    heading: "Toeristen kunnen het lezen.",
    headingAccent: "Toeristen bestellen meer.",
    sub: "Vertaal je menu in 35 talen met één klik. 14 dagen gratis proef. Geen creditcard. Geen kosten per taal, ooit.",
  },
};
