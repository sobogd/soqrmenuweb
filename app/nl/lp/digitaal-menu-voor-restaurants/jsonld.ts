...
const URL_SELF = "https://iq-rest.com/nl/lp/digitaal-menu-voor-restaurants";
const URL_HOME = "https://iq-rest.com/nl";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digitaal menu voor restaurants",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digitaal menu voor restaurants", item: URL_SELF },
    ],
  };
