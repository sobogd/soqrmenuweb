...
const URL_SELF = "https://iq-rest.com/fi/lp/digitaalinen-ruokalista-ravintoloille";
const URL_HOME = "https://iq-rest.com/fi";
...
export function buildJsonLd(texts: LandingTexts) {
  ...
  const softwareApp = {
    ...
    name: "IQ Rest — Digitaalinen ruokalista ravintoloille",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Digitaalinen ruokalista ravintoloille", item: URL_SELF },
    ],
  };
