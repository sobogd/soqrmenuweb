...
export const CRO: CroCopy = {
  ...
  benefits: [
    { Icon: Languages, tag: "Digitaalinen menu", title: "Menu joka näyttää verkkosivulta, ei PDF:ltä.", bullets: ["35 tekoälykieltä","Premium-design","Hinnat heti ajan tasalla"], image: "/landing/feature-design.webp", imageAlt: "Kaksi puhelinta kahvilan pöydällä: digitaalisen menun aloitusnäyttö ja yhteystietosivu kartalla" },
    { Icon: ChefHat, tag: "Keittiönäyttö", title: "Keittiö viimein paperittomana.", bullets: ["Suoraan näytölle","Merkinnät ja allergeenit","Tabletti tai puhelin"], image: "/landing/feature-kds-cards.webp", imageAlt: "Tabletti tiskillä näyttää keittiönäytön tilauksineen pöydittäin" },
    { Icon: CalendarCheck, tag: "Varaukset", title: "Pöydät jotka varaavat itsensä, 24/7.", bullets: ["Itsevaraus","Automaattinen vahvistus","Kalenteri pöydittäin"], image: "/landing/feature-booking-calendar.webp", imageAlt: "Kaksi tablettia näyttää varauskalenterin: päivänäkymä pöydittäin ja kuukausinäkymä" },
    { Icon: Receipt, tag: "Tilaus pöydässä", title: "Ota tilaukset ilman lehtiötä — valinnainen.", bullets: ["Asiakas tai tarjoilija","Suoraan keittiöön","Päälle/pois milloin vain"], image: "/landing/feature-orders.webp", imageAlt: "Tarjoilija ottaa tilauksen pöydässä puhelimella, se päätyy keittiönäytölle" },
  ],
