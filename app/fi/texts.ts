...
export const TEXTS: LandingTexts = {
  ...
  hero: {
    ...
    qr: { headline: "QR-menu 5 minuutissa.", sub: "Valmis ravintolan verkkosivusto — ilman kehittäjiä ja alihankkijoita. Suorat tilaukset, varaukset ja asiakasanalytiikka yhdellä tilauksella." },
    web: { headline: "Ravintolasivut 5 minuutissa.", sub: "Valmis ravintolan verkkosivusto — ilman kehittäjiä ja alihankkijoita. Suorat tilaukset, varaukset ja asiakasanalytiikka yhdellä tilauksella." },
