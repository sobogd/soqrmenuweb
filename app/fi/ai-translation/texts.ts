...
export const TEXTS: FeatureTexts = {
  meta: {
    title: "AI-pohjainen ravintolan ruokalistakäännös — 35 kieltä, yhdellä napautuksella",
    description:
      "Käännä koko ravintolasi ruokalista 35 kielelle AI:n avulla, joka ymmärtää keittiökontekstin. Yksi napautus, välittömät tulokset. 14 päivän ilmainen kokeilu, ei luottokorttia.",
    canonical: "https://iq-rest.com/fi/ai-translation",
    ogLocale: "fi_FI",
    ogTitle: "AI-ruokalistakäännös — käännä ravintolasi ruokalista 35 kielelle",
    ogDescription:
      "Turistit tilaavat enemmän, kun he ymmärtävät ruokalistan. Ruoalle rakennettu AI-käännös — säilyttää ruokien nimet, kirjoittaa kuvaukset oikein, valmis välittömästi.",
  },
  ...
  pricing: {
    ...
    headingAccent: "35 kieltä mukana.",
    sub: "AI-käännös, QR-ruokalista, verkkotilaaminen ja varaukset — kaikki yhdellä kiinteällä hinnalla. Ei kielikohtaisia maksuja, ei käännöskohtaisia maksuja, koskaan.",
  },

  faq: {
    sub: "Kaikki, mitä ravintoloitsijat kysyvät ruokalistakäännöksestä. Etkö löydä omaasi? Pingaa meitä WhatsAppissa — oikeat ihmiset vastaavat.",
    items: [
      {
        q: "Kuinka tarkka AI on Google Translateen verrattuna?",
        a: "Paljon parempi ruoan suhteen. Google Translate ei tiedä, ettei 'pulpo a la gallega' tulisi kääntää sana sanalta, tai että 'amuse-bouche' pysyy ranskaksi fine dining -ruokalistalla. AI:mme on koulutettu oikeilla ravintoloiden ruokalistoilla ja tietää, milloin kääntää, milloin translitteroida ja milloin säilyttää alkuperäinen. Voit myös muokata mitä tahansa käännöstä manuaalisesti — hyödyllistä alueelliselle oikeinkirjoitukselle.",
      },
      {
        q: "Kuinka montaa kieltä tuette?",
        a: "35 kieltä suoraan paketista: englanti, espanja, saksa, ranska, italia, portugali, hollanti, puola, tšekki, slovakki, unkari, romania, bulgaria, kroatia, serbia, slovenia, kreikka, turkki, venäjä, ukraina, liettua, latvia, viro, suomi, ruotsi, norja, tanska, islanti, katalaani, iiri, arabia, persia, japani, korea ja kiina. RTL-kirjoitukset kuten arabia ja persia renderöityvät oikein suoraan paketista.",
      },
      {
        q: "Pitääkö minun kääntää kaikki ensin manuaalisesti?",
        a: "Ei. Kirjoita ruokalistasi omalla kielelläsi, klikkaa 'käännä', valitse haluamasi kielet — AI tekee loput. Voit tarkistaa ja muokata mitä tahansa käännöstä, mutta sinun ei tarvitse. Useimmat ravintolat asettavat sen kerran ja unohtavat sen.",
      },
      {
        q: "Mitä tapahtuu, kun lisään uuden ruoan?",
        a: "Se kääntyy automaattisesti jokaiselle käyttöön ottamallesi kielelle. Lisäät 'Tryffeliriisotto' suomeksi kuvauksen kanssa, painat tallenna, ja sekuntien sisällä ruoka näkyy käännettynä kaikilla aktiivisilla kielilläsi. Ei mitään uudelleenajoa, ei eräajoja.",
      },
      {
        q: "Voivatko vieraat vaihtaa kieltä ruokalistalla?",
        a: "Kyllä. QR-ruokalistan yläosassa on kielivalitsin — vieraat napauttavat lippua, koko ruokalista renderöityy uudelleen heidän kielellään. Tai voit antaa sen tunnistaa automaattisesti puhelimen kieliasetuksista, jolloin ranskalainen turisti, joka skannaa QR-koodisi, näkee ranskan välittömästi. Ei painikkeita etsittävänä, ei kitkaa.",
      },
    ],
  },

  finalCta: {
    heading: "Turistit voivat lukea sen.",
    headingAccent: "Turistit tilaavat enemmän.",
    sub: "Käännä ruokalistasi 35 kielelle yhdellä klikkauksella. 14 päivän ilmainen kokeilu. Ei luottokorttia. Ei kielikohtaisia maksuja, koskaan.",
  },
};
