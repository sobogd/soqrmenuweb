...
export enum DashboardEvent {
  ...
  SHOWED_ONBOARDING_MENU = "showed_onboarding_menu",
  CLICKED_ONBOARDING_SKIP = "clicked_onboarding_skip",
  CLICKED_ONBOARDING_MANUAL = "clicked_onboarding_manual",
  SHOWED_ONBOARDING_CATEGORY = "showed_onboarding_category",
  FOCUSED_ONBOARDING_CATEGORY_NAME = "focused_onboarding_category_name",
  CLICKED_ONBOARDING_SAVE_CATEGORY = "clicked_onboarding_save_category",
  SHOWED_ONBOARDING_ITEM = "showed_onboarding_item",
  FOCUSED_ONBOARDING_ITEM_NAME = "focused_onboarding_item_name",
  FOCUSED_ONBOARDING_ITEM_PRICE = "focused_onboarding_item_price",
  FOCUSED_ONBOARDING_ITEM_DESCRIPTION = "focused_onboarding_item_description",
  CLICKED_ONBOARDING_SAVE_ITEM = "clicked_onboarding_save_item",
  SHOWED_ONBOARDING_DONE = "showed_onboarding_done",
  CLICKED_ONBOARDING_ADD_ITEM = "clicked_onboarding_add_item",
  CLICKED_ONBOARDING_ADD_CATEGORY = "clicked_onboarding_add_category",
  CLICKED_ONBOARDING_FINISH = "clicked_onboarding_finish",
  CLICKED_ONBOARDING_TEMPLATES = "clicked_onboarding_templates",
  SHOWED_ONBOARDING_TEMPLATES = "showed_onboarding_templates",
  CLICKED_TEMPLATE_RESTAURANT = "clicked_template_restaurant",
  CLICKED_TEMPLATE_CAFE = "clicked_template_cafe",
  CLICKED_TEMPLATE_BAR = "clicked_template_bar",
...
export const EVENT_LABELS: Record<string, string> = {
  ...
  [DashboardEvent.SHOWED_ONBOARDING_MENU]: "Showed Onboarding Menu",
  [DashboardEvent.CLICKED_ONBOARDING_SKIP]: "Clicked Skip Menu Setup",
  [DashboardEvent.CLICKED_ONBOARDING_MANUAL]: "Clicked Manual Builder",
  [DashboardEvent.SHOWED_ONBOARDING_CATEGORY]: "Showed Onboarding Category",
  [DashboardEvent.FOCUSED_ONBOARDING_CATEGORY_NAME]: "Focused Category Name",
  [DashboardEvent.CLICKED_ONBOARDING_SAVE_CATEGORY]: "Clicked Save Category",
  [DashboardEvent.SHOWED_ONBOARDING_ITEM]: "Showed Onboarding Item",
  [DashboardEvent.FOCUSED_ONBOARDING_ITEM_NAME]: "Focused Item Name",
  [DashboardEvent.FOCUSED_ONBOARDING_ITEM_PRICE]: "Focused Item Price",
  [DashboardEvent.FOCUSED_ONBOARDING_ITEM_DESCRIPTION]: "Focused Item Description",
  [DashboardEvent.CLICKED_ONBOARDING_SAVE_ITEM]: "Clicked Save Item",
  [DashboardEvent.SHOWED_ONBOARDING_DONE]: "Showed Onboarding Done",
  [DashboardEvent.CLICKED_ONBOARDING_ADD_ITEM]: "Clicked Add Another Item",
  [DashboardEvent.CLICKED_ONBOARDING_ADD_CATEGORY]: "Clicked Add Another Category",
  [DashboardEvent.CLICKED_ONBOARDING_FINISH]: "Clicked Finish Onboarding",
  [DashboardEvent.CLICKED_ONBOARDING_TEMPLATES]: "Clicked Industry Templates",
  [DashboardEvent.SHOWED_ONBOARDING_TEMPLATES]: "Showed Onboarding Templates",
  [DashboardEvent.CLICKED_TEMPLATE_RESTAURANT]: "Clicked Template Restaurant",
  [DashboardEvent.CLICKED_TEMPLATE_CAFE]: "Clicked Template Cafe",
  [DashboardEvent.CLICKED_TEMPLATE_BAR]: "Clicked Template Bar",
  [DashboardEvent.TEMPLATE_APPLY_SUCCESS]: "Template Applied Successfully",
  [DashboardEvent.TEMPLATE_APPLY_ERROR]: "Template Apply Error",
